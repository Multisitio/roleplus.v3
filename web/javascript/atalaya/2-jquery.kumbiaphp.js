(function($) {
    $.KumbiaPHP = {
        ...
        clone_content_append: function() {
            let params = $(this).data('clone_content_append');
            let el = params.split(', ')[0];
            let to = params.split(', ')[1];
            /*let temp = document.querySelector(el);
            let clon = temp.content.cloneNode();
            document.querySelector(to).appendChild(clon);*/
            $($(el).prop('content')).clone().appendTo(to);
        },
        ...
        bind: function() {
            ...
            $('body').on('click', '[data-clone_content_append]', this.clone_content_append);
